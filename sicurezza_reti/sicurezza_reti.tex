...
\textbf{Principio del privilegio minimo}
\textbf{Un programma non dovrebbe utilizzare più privilegi di 
quelli necessari all'attività.}

Il nostro programma vulnerabile dispone di più privilegi del 
necessario durante l'apertura del file.
